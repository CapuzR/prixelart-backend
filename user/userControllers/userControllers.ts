...
export const readMyUser = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    if (!req.userId) {
...
export const readUserById = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
export const readAllUsers = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
export const readUserByAccount = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
export const getUsersByIds = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
export const deleteUser = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  ...
  try {
    ...
    if (!req.permissions?.modifyU) {
      res.send({
        success: false,
        message: "No tienes permiso para modificar Useristradores.",
      });
      return;
    }
