...
const readManufacturer = async (req, res) => {
  try {
    ...
    const readedManufacturer = await manufacturerServices.readManufacturer(
      user
    );
...
const readAllManufacturers = async (req, res) => {
  try {
    const readedManufacturers =
      await manufacturerServices.readAllManufacturers();
...
const readAllManufacturersFull = async (req, res) => {
  try {
    const readedManufacturers =
      await manufacturerServices.readAllManufacturersFull();
    res.send(readedManufacturers);
  } catch (err) {
    res.status(500).send(err);
  }
...
const updateManufacturer = async (req, res) => {
  try {
    ...
    const updates = await manufacturerServices.updateManufacturer(
      manufacturer,
      user
    );
...
const disableManufacturer = async (req, res) => {
  try {
    const disabledUser = await manufacturerServices.disableManufacturer(
      req.body
    );
